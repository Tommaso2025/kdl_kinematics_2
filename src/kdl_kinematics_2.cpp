 #include <kdl_kinematics_2/kdl_kinematics_2.h>  
 #include <kdl_kinematics_2/chainiksolver_vel_mimic_svd.hpp>
 ...
 {
 static rclcpp::Logger LOGGER = rclcpp::get_logger("moveit_kdl_kinematics_2.kdl_kinematics_2");
  
 rclcpp::Clock KDLKinematics2::steady_clock_{ RCL_STEADY_TIME };
  
 KDLKinematics2::KDLKinematics2() : initialized_(false)
 {
 }
  
 void KDLKinematics2::getRandomConfiguration(Eigen::VectorXd& jnt_array) const
 {
   state_->setToRandomPositions(joint_model_group_);
   state_->copyJointGroupPositions(joint_model_group_, &jnt_array[0]);
 }
  
 void KDLKinematics2::getRandomConfiguration(const Eigen::VectorXd& seed_state,
 ...
 bool KDLKinematics2::checkConsistency(const Eigen::VectorXd& seed_state,
                                            const std::vector<double>& consistency_limits,
 ...
 void KDLKinematics2::getJointWeights()
 {
 ...
 bool KDLKinematics2::initialize(const rclcpp::Node::SharedPtr& node, const moveit::core::RobotModel& robot_model,
 ...
 bool KDLKinematics2::timedOut(const rclcpp::Time& start_time, double duration) const
 {
   return ((steady_clock_.now() - start_time).seconds() >= duration);
 }
  
 bool KDLKinematics2::getPositionIK(const geometry_msgs::msg::Pose& ik_pose,
 ...
 bool KDLKinematics2::searchPositionIK(const geometry_msgs::msg::Pose& ik_pose,
 ...
 int KDLKinematics2::CartToJnt(KDL::ChainIkSolverVelMimicSVD& ik_solver, const KDL::JntArray& q_init,
 ...
 void KDLKinematics2::clipToJointLimits(const KDL::JntArray& q, KDL::JntArray& q_delta,
 ...
 bool KDLKinematics2::getPositionFK(const std::vector<std::string>& link_names,
 ...
 const std::vector<std::string>& KDLKinematics2::getJointNames() const
 {
   return solver_info_.joint_names;
 }
  
 const std::vector<std::string>& KDLKinematics2::getLinkNames() const
 {
 ...
 // register KDLKinematics2 as a KinematicsBase implementation
 #include <class_loader/class_loader.hpp>
 CLASS_LOADER_REGISTER_CLASS(kdl_kinematics_2::KDLKinematics2, kinematics::KinematicsBase)
